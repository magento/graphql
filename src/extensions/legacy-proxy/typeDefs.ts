/* Autogenerated, do not hand edit. See scripts/update-legacy-schema.js */
...
export const typeDefs = gql`
    ...
    type AvailableShippingMethod {
        ...
        base_amount: Money
            @deprecated(
                reason: "The field should not be used on the storefront"
            )
        carrier_code: String!
    ...
    type BundleItemOption {
        ...
        qty: Float
            @deprecated(
                reason: "The \`qty\` is deprecated. Use \`quantity\` instead."
            )
    ...
    type BundleProduct implements ProductInterface & PhysicalProductInterface & CustomizableProductInterface {
        ...
        price: ProductPrices
            @deprecated(
                reason: "Use price_range for product price information."
            )
        ...
        tier_price: Float
            @deprecated(
                reason: "Use price_tiers for product tier price information."
            )
        ...
        url_path: String
            @deprecated(
                reason: "Use product's \`canonical_url\` or url rewrites instead"
            )
    ...
    type CustomerAddress {
        ...
        custom_attributes: [CustomerAddressAttribute]
            @deprecated(
                reason: "Custom attributes should not be put into container"
            )
    ...
    type CustomerOrder {
        ...
        id: Int
        increment_id: String
            @deprecated(reason: "Use the order_number instead.")
    ...
    enum DownloadableFileTypeEnum {
        FILE
            @deprecated(
                reason: "\`sample_url\` serves to get the downloadable sample"
            )
        URL
            @deprecated(
                reason: "\`sample_url\` serves to get the downloadable sample"
    ...
    type DownloadableProductLinks {
        id: Int
            @deprecated(
                reason: "This information should not be exposed on frontend"
            )
    ...
    type LayerFilterItem implements LayerFilterItemInterface {
        ...
        """
        items_count: Int
            @deprecated(reason: "Use AggregationOption.count instead.")

        """
        Filter label.
        """
        label: String
            @deprecated(reason: "Use AggregationOption.label instead.")
    ...
    type ProductTierPrices {
        ...
        customer_group_id: String
            @deprecated(
                reason: "customer_group_id is not relevant for storefront."
            )
    ...
    extend type Query {
        ...
        category(
            ...
            @deprecated(
                reason: "Use 'categoryList' query instead of 'category' query"
            )
    ...
    type ShippingCartAddress implements CartAddressInterface {
        ...
        items_weight: Float
            @deprecated(
                reason: "This information shoud not be exposed on frontend"
            )
        lastname: String!
        postcode: String
        region: CartAddressRegion
    ...
    type WishlistOutput {
        ...
        items: [WishlistItem]
            @deprecated(
                reason: "Use field \`items\` from type \`Wishlist\` instead"
            )
        ...
        items_count: Int
            @deprecated(
                reason: "Use field \`items_count\` from type \`Wishlist\` instead"
            )
        ...
        sharing_code: String
            @deprecated(
                reason: "Use field \`sharing_code\` from type \`Wishlist\` instead"
            )
        ...
        updated_at: String
            @deprecated(
                reason: "Use field \`updated_at\` from type \`Wishlist\` instead"
            )
    }
`;
